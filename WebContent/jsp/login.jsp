...
<form class="form-horizontal" action="${pageContext.request.contextPath }/user" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
	    ...
	    <div class="col-sm-3">
	       <img alt="验证码" src="<%=request.getContextPath() %>/code" id="code" />
  ...
  <div class="form-group">
    ...
    height:35px;width:100px;color:white;" onclick="javascript:verificationcode()" >
    </div>
  </div>
</form>
</div>			
	...
	<script type="text/javascript">
		 function reload(){
			document.getElementById("code").src="<%=request.getContextPath() %>/code?date="+new Date().getTime();
			$("#checkcode").val("");   // 将验证码清空
		} 
		 
		 function verificationcode(){
			 var text=$.trim($("#checkcode").val());
			 $.post("${pageContext.request.contextPath}/verification",{op:text},function(data){
