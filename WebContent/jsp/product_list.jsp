<%@page import="com.ouc.edu.service.impl.ProductServiceImpl"%>
<%@page import="com.ouc.edu.service.ProductService"%>
<%@page import="com.ouc.edu.utils.CookUtils"%>
...
<html>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
				<div class="col-md-12">
					<ol class="breadcrumb">
						<li><a href="${pageContext.request.contextPath }">首页&nbsp;&nbsp;&gt;</a>
							<a href="${pageContext.request.contextPath }/product?method=getById&pid=${p.pid}">${p.cid }</a>
			...
			<c:forEach items="${pb.data }" var="p">
				<div class="col-md-2">
					...
					<p><a href="p${pageContext.request.contextPath }/product?method=getById&pid=${p.pid}" style='color:green'>${fn:substring(p.pname,0,10) }..</a></p>
		...
		<!--
			...
			<img src="${pageContext.request.contextPath}/${pb.pimage}" width="130px" height="130px" /></li>
			</ul>
        -->
